	...
	return (
	  <div className="container mx-auto">
		<h1>
		  <Navbar />
		  <PageWrapper>
			<section className="text-gray-600 body-font pt-24 sm:pt-20 lg:max-w-7xl lg:px-5">
			  <div className="container mx-auto flex px-5 pb-24 md:flex-row flex-col items-center">
				<div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0 relative overflow-hidden">
				  <motion.img
				  ...
				  <motion.img
					...
					className="object-cover object-center rounded absolute inset-0"
					alt="hero"
